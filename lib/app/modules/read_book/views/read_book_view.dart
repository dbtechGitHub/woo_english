...
class ReadBookView extends GetView<ReadBookController> {
                          ...
                          child: ScrollConfiguration(
                            ...
                            child: Scrollbar(
                              child: Obx(() {
                                ...
                                scrollControllerMain: controller.scrollController,
                                  wantValueUpdate:
          ...
          children: [
            AnimatedOpacity(
              ...
              child: FloatingActionButton(
                  ...
                  child:  Icon(Icons.arrow_upward,color: Col.secondary,) ),
            ),
          ],
        ),
      );
  ...
  PopupMenuItem commonPopUpMenuItem(
      {required List<String> innerList,
